...
exports.processIMediaPlayerAudioFrameObserver = processIMediaPlayerAudioFrameObserver;
...
function processIMediaPlayerAudioFrameObserver(handler, event, jsonParams) {
  switch (event) {
    case 'onFrame':
