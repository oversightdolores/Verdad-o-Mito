...
class RtcEngineExInternal extends _IAgoraRtcEngineExImpl.IRtcEngineExImpl {
  constructor() {
    super(...arguments);
    _defineProperty(this, "_media_engine", new _MediaEngineInternal.MediaEngineInternal());
    _defineProperty(this, "_media_recorder", new _MediaRecorderInternal.MediaRecorderInternal());
    _defineProperty(this, "_music_content_center", new _MusicContentCenterInternal.MusicContentCenterInternal());
    _defineProperty(this, "_local_spatial_audio_engine", new _LocalSpatialAudioEngineInternal.LocalSpatialAudioEngineInternal());
    _defineProperty(this, "_events", new Map());
  }
  initialize(context) {
    const ret = super.initialize(context);
    _IrisApiEngine.callIrisApi.call(this, 'RtcEngine_setAppType', {
      appType: 8
    });
    return ret;
  }
  ...
  addListener(eventType, listener) {
    ...
    const callback = function () {
      if ((arguments.length <= 0 ? undefined : arguments[0]) !== _IrisApiEngine.EVENT_TYPE.IRtcEngine) {
        return;
      }
      (0, _IAgoraRtcEngineImpl.processIRtcEngineEventHandler)({
        [eventType]: listener
      }, eventType, arguments.length <= 1 ? undefined : arguments[1]);
      (0, _IAgoraRtcEngineImpl.processIDirectCdnStreamingEventHandler)({
        [eventType]: listener
      }, eventType, arguments.length <= 1 ? undefined : arguments[1]);
      (0, _IAgoraRtcEngineImpl.processIMetadataObserver)({
        [eventType]: listener
      }, eventType, arguments.length <= 1 ? undefined : arguments[1]);
      (0, _AgoraBaseImpl.processIAudioEncodedFrameObserver)({
        [eventType]: listener
      }, eventType, arguments.length <= 1 ? undefined : arguments[1]);
      (0, _AgoraMediaBaseImpl.processIAudioSpectrumObserver)({
        [eventType]: listener
      }, eventType, arguments.length <= 1 ? undefined : arguments[1]);
    };
