...
export class IMediaEngineImpl {
  ...
  pushAudioFrame(type, frame) {
    let wrap = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    let sourceId = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
  ...
  getApiTypeFromPushAudioFrame(type, frame) {
    let wrap = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    let sourceId = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
  ...
  setExternalVideoSource(enabled, useTexture) {
    let sourceType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : ExternalVideoSourceType.VideoFrame;
    let encodedVideoOption = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : new SenderOptions();
  ...
  setExternalAudioSource(enabled, sampleRate, channels) {
    let sourceNumber = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
    let localPlayback = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    let publish = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : true;
  ...
  setDirectExternalAudioSource(enable) {
    let localPlayback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  ...
  getApiTypeFromSetDirectExternalAudioSource(enable) {
    let localPlayback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
