...
import { VideoSourceType, AudioScenarioType, VideoMirrorModeType } from '../AgoraBase';
import { MediaSourceType } from '../AgoraMediaBase';
export function processIRtcEngineEventHandler(handler, event, jsonParams) {
  switch (event) {
...
// @ts-ignore
export class IVideoDeviceManagerImpl {
...
export function processIMetadataObserver(handler, event, jsonParams) {
  switch (event) {
...
export function processIDirectCdnStreamingEventHandler(handler, event, jsonParams) {
  switch (event) {
...
export class IRtcEngineImpl {
  ...
  setBeautyEffectOptions(enabled, options) {
    let type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : MediaSourceType.PrimaryCameraSource;
  ...
  enableVirtualBackground(enabled, backgroundSource, segproperty) {
    let type = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : MediaSourceType.PrimaryCameraSource;
  ...
  enableRemoteSuperResolution(userId, enable) {
  ...
  getApiTypeFromEnableRemoteSuperResolution(userId, enable) {
  ...
  setAudioProfile(profile) {
    let scenario = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : AudioScenarioType.AudioScenarioDefault;
  ...
  getApiTypeFromUploadLogFile(requestId) {
    return 'RtcEngine_uploadLogFile';
  }
  setLocalRenderMode(renderMode) {
    let mirrorMode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : VideoMirrorModeType.VideoMirrorModeAuto;
  ...
  enableEchoCancellationExternal(enabled, audioSourceDelay) {
  ...
  getApiTypeFromEnableEchoCancellationExternal(enabled, audioSourceDelay) {
  ...
  startPrimaryCustomAudioTrack(config) {
  ...
  getApiTypeFromStartPrimaryCustomAudioTrack(config) {
  ...
  getApiTypeFromStopPrimaryCustomAudioTrack() {
    return 'RtcEngine_stopPrimaryCustomAudioTrack';
  }
  startSecondaryCustomAudioTrack(config) {
  ...
  getApiTypeFromStartSecondaryCustomAudioTrack(config) {
  ...
  getApiTypeFromStopSecondaryCustomAudioTrack() {
  ...
  registerExtension(provider, extension) {
    let type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : MediaSourceType.UnknownMediaSource;
  ...
  enableExtension(provider, extension) {
    ...
    let type = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : MediaSourceType.UnknownMediaSource;
  ...
  setExtensionProperty(provider, extension, key, value) {
    let type = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : MediaSourceType.UnknownMediaSource;
  ...
  startPrimaryCameraCapture(config) {
  ...
  getApiTypeFromStartPrimaryCameraCapture(config) {
    return 'RtcEngine_startPrimaryCameraCapture';
  }
  startSecondaryCameraCapture(config) {
  ...
  getApiTypeFromStartSecondaryCameraCapture(config) {
  ...
  getApiTypeFromStopPrimaryCameraCapture() {
  ...
  getApiTypeFromStopSecondaryCameraCapture() {
  ...
  startPrimaryScreenCapture(config) {
  ...
  getApiTypeFromStartPrimaryScreenCapture(config) {
    return 'RtcEngine_startPrimaryScreenCapture';
  }
  startSecondaryScreenCapture(config) {
  ...
  getApiTypeFromStartSecondaryScreenCapture(config) {
  ...
  getApiTypeFromStopPrimaryScreenCapture() {
  ...
  getApiTypeFromStopSecondaryScreenCapture() {
  ...
  getApiTypeFromSetEncryptionMode(encryptionMode) {
  ...
  getApiTypeFromSetEncryptionSecret(secret) {
  ...
  startAudioFrameDump(channelId, userId, location, uuid, passwd, durationMs, autoUpload) {
  ...
  getApiTypeFromStartAudioFrameDump(channelId, userId, location, uuid, passwd, durationMs, autoUpload) {
    return 'RtcEngine_startAudioFrameDump';
  }
  stopAudioFrameDump(channelId, userId, location) {
  ...
  getApiTypeFromStopAudioFrameDump(channelId, userId, location) {
  ...
  getApiTypeFromStartChannelMediaRelay(configuration) {
  ...
  getApiTypeFromUpdateChannelMediaRelay(configuration) {
  ...
  adjustCustomAudioPublishVolume(sourceId, volume) {
  ...
  getApiTypeFromAdjustCustomAudioPublishVolume(sourceId, volume) {
    return 'RtcEngine_adjustCustomAudioPublishVolume';
  }
  adjustCustomAudioPlayoutVolume(sourceId, volume) {
  ...
  getApiTypeFromAdjustCustomAudioPlayoutVolume(sourceId, volume) {
  ...
  getApiTypeFromGetMediaRecorder() {
