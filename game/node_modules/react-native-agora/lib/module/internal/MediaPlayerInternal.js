...
import { IMediaPlayerImpl, processIMediaPlayerAudioFrameObserver, processIMediaPlayerVideoFrameObserver } from '../impl/IAgoraMediaPlayerImpl';
...
export class MediaPlayerInternal extends IMediaPlayerImpl {
  ...
  addListener(eventType, listener) {
    ...
    const callback = function () {
      ...
      if (data[1].playerId === _this._mediaPlayerId) {
...
_defineProperty(MediaPlayerInternal, "_source_observers", new Map());
_defineProperty(MediaPlayerInternal, "_audio_frame_observers", new Map());
_defineProperty(MediaPlayerInternal, "_video_frame_observers", new Map());
_defineProperty(MediaPlayerInternal, "_audio_spectrum_observers", new Map());
