...
const AdManagerAdaptiveBannerView = _reactNative.UIManager.getViewManagerConfig(ComponentName) != null ? (0, _reactNative.requireNativeComponent)(ComponentName) : () => {
  throw new Error(_Constants.LINKING_ERROR);
};
class AdaptiveBanner extends _react.default.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return /*#__PURE__*/_react.default.createElement(AdManagerAdaptiveBannerView, _extends({}, this.props, {
...
exports.AdaptiveBanner = AdaptiveBanner;
