...
const AdManagerBannerView = UIManager.getViewManagerConfig(ComponentName) != null ? requireNativeComponent(ComponentName) : () => {
...
export class Banner extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement(AdManagerBannerView, _extends({}, this.props, {
